...
template<typename State>
inline core::Mode &SharedBlock<State>::owner() const
{
	return owner_;
}

template<typename State>
inline accptr_t SharedBlock<State>::acceleratorAddr(const hostptr_t addr) const
{
...
template<typename State>
inline accptr_t SharedBlock<State>::acceleratorAddr() const
{
