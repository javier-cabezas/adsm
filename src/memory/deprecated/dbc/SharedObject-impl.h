...
SharedObject<State>::SharedObject(__impl::memory::protocol_interface &protocol, __impl::core::Mode &owner, hostptr_t addr, size_t size, typename State::ProtocolState init, gmacError_t &err) :
