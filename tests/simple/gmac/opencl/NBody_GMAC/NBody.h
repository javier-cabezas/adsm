...
class NBody
{
    ...
    cl_float* currPos;                  /**< Position of partciles */
    cl_float* currVel;                  /**< Velocity of partciles */
    cl_float* newPos;                  /**< Position of partciles */
    cl_float* newVel;                  /**< Velocity of partciles */
    ecl_kernel kernel;                  /**< ECL kernel */
    cl_int numParticles;
    int iterations;
