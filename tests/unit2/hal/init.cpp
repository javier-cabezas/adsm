...
void do_object_copy_host()
{
    ...
    I_HAL::phys::processing_unit *pUnit0, *pUnit1;
    I_HAL::phys::aspace *pas0;
    ...
    pUnit0 = *plat0->get_processing_units(PUnit1).begin();

    pas0 = &pUnit0->get_paspace();
    pas1 = &pUnit1->get_paspace();
    ...
    ptr ptrBase0 = as0->map(*obj0, GMAC_PROT_READWRITE, err);
    ASSERT_TRUE(err == I_HAL::error::HAL_SUCCESS);
    ptr ptrBase1 = as1->map(*obj0, GMAC_PROT_READWRITE, err);
    ASSERT_TRUE(err == I_HAL::error::HAL_SUCCESS);
